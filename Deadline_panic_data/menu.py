...
def menu(app):
    ...
    def menu_new_game():
        ...
        image(os.path.join(dossier_image, "1.png"), (TAILLE_IM, TAILLE_IM), parent=f1).pack(int(LX*0.07), 5, "center", "left")
        image(os.path.join(dossier_image, "2.png"), (TAILLE_IM, TAILLE_IM), parent=f1).pack(int(LX*0.07), 5, "center", "left")
        image(os.path.join(dossier_image, "3.png"), (TAILLE_IM, TAILLE_IM), parent=f1).pack(int(LX*0.07), 5, "center", "left")
